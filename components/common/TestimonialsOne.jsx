...
export default function TestimonialsOne() {
  return (
    <section
      className="layout-pb-lg custom-linear-blue-top"
    ...
    >
      ...
      {/* ✅ Testimonials Swiper */}
      <div className="js-section-slider pt-50" style={{ padding: "0 2vw" }}>
        <Swiper
            ...
            <SwiperSlide key={i} className="swiper-slide">
              ...
              >
                <div className="testimonials__content">
                  ...
                  <p className="testimonials__text">{`“${elm.description}”`}</p>
        ...
        {/* ✅ Navigation Buttons */}
        <div className="d-flex x-gap-20 items-center justify-end pt-60 lg:pt-40 pr-8">
