            ...
            <div className="row y-gap-40 items-center">
              <div className="col-lg-6" data-aos="fade-left">
                ...
                <p className="text-16 text-[#160643] mb-20 leading-relaxed">
                  At CSEI, every season brings exciting events, festivals, and
                  academic workshops that foster learning, fun, and bonding.
                </p>
                <p className="text-16 text-[#160643] leading-relaxed">
                  From tech summits and cultural fests to community outreach and
                  guest lectures, students are always encouraged to participate,
                  organize, and lead. These experiences enrich student life and
              ...
              <div className="col-lg-6" data-aos="fade-right">
                <Image
                  src="/assets/img/life/events.jpg"
