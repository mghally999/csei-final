  ...
  return (
    <section className="px-4 py-6 text-gray-800">
      ...
      <p className="mb-4 text-lg">
        ...
        <strong>18 years and above</strong> with a passion for coffee and
        customer service.
      </p>
      <p className="mb-4 text-lg">
      ...
      <ul className="pl-6 space-y-3 text-base leading-relaxed list-[circle] marker:text-gray-500 marker:text-sm">
        ...
        <li>Basic proficiency in reading and communicating in English</li>
        <li>Interest in specialty coffee or café service industry</li>
        <li>
          Prior hospitality or customer-facing experience (preferred)
          <div className="text-sm text-gray-600 pl-4">
            (Experience may substitute for formal qualifications)
          </div>
        </li>
      </ul>
      <p className="mt-6 text-base">
        For personalized guidance on eligibility, please contact our admissions
        team.
      </p>
    </section>
  );
