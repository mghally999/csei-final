        ...
        <div className="row y-gap-30 justify-center align-center flex-row-reverse lg:flex-col mb-20">
          ...
          <div className="col-xl-6 col-lg-6 d-flex flex-column justify-center">
            <div className="bg-white text-black p-8 rounded-lg shadow-lg">
              <div className="badge px-15 py-8 text-11 bg-blue-1 text-white fw-600 mb-4 inline-block">
              ...
              <p className="text-16 mb-3 leading-relaxed">
                ...
                <strong>KHDA-approved Barista Certificate</strong> upon
                successful completion.
              </p>

              <p className="text-16 mb-3 leading-relaxed">
                Recognized locally and internationally, it opens doors to
                barista roles, specialized training, or career advancement in
                coffee.
              </p>
