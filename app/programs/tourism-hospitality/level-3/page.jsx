...
const menuItems = [
  ...
  { id: 5, text: "Assessment and Verification" },
];
            ...
            <div className="row y-gap-40">
              ...
              <div className="col-lg-8">
                <div className="tabs__content js-tabs-content space-y-12 text-gray-800">
                  ...
                  {activeTab === 2 && <EntryRequirements />}
                  {activeTab === 3 && <QualificationStructure />}
                  {activeTab === 4 && <AllUnits />}
                  {activeTab === 5 && <AssessmentVerification />}
                </div>
              </div>
            </div>
          </div>
