export default function EntryRequirements() {
  return (
    <section className="px-4 py-6 text-gray-800">
      ...
      <h3 className="text-2xl font-semibold mb-4">Equivalences</h3>

      <p className="text-base leading-relaxed">
        OTHM qualifications at <strong>RQF Level 4</strong> represent practical
        knowledge, skills, capabilities, and competences that are assessed in
        academic terms as being equivalent to{" "}
        <strong>Higher National Certificates (HNC)</strong> and{" "}
        <strong>Year 1 of a three-year UK Bachelor's degree programme</strong>.
      </p>
    </section>
  );
}
