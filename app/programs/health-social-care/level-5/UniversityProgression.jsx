          ...
          <div className="col-xl-6 col-lg-6 d-flex flex-column justify-center">
            <div className="bg-white text-black p-8 rounded-lg shadow-lg">
              ...
              <h2 className="mb-4 text-26 fw-600 flex items-center gap-2">
                Advance to a UK Bachelor’s Degree – Final Year
              </h2>
              ...
              <p className="text-16 mb-3 leading-relaxed">
                ...
                <strong>OTHM Level 6 Diplomas</strong>.
              </p>

              <p className="text-16 mb-3 leading-relaxed">
                This qualification has been developed with{" "}
                <strong>career progression</strong> and{" "}
                <strong>professional recognition</strong> in mind, allowing
                learners to enhance both their academic and professional
                journey.
              </p>
              ...
              <p className="text-16 mb-3 leading-relaxed">
                ...
                entry into the{" "}
                <strong>final year of a UK Bachelor’s degree</strong>.
              </p>

              <p className="text-16 mb-3 leading-relaxed">
                For more information on university pathways, please refer to
                OTHM’s official progression page.
              </p>
