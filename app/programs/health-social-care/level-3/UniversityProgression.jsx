  ...
  return (
    <section className="bg-[#140342] py-20 text-white">
      <div className="container">
        <div className="row y-gap-30 justify-center align-center flex-row-reverse lg:flex-col">
          {/* IMAGE */}
          <div className="col-xl-5 col-lg-6">
            <div className="relative">
              <Image
                ...
                src="/assets/img/othm/university-progession.jpg"
          ...
          <div className="col-xl-6 col-lg-6 d-flex flex-column justify-center">
            <div className="bg-white text-black p-8 rounded-lg shadow-lg">
              ...
              <p className="text-16 mb-3 leading-relaxed">
                ...
                <strong>
                  OTHM Level 3 Diploma in Health and Social Care Management
                </strong>{" "}
