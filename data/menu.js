export const menuList = [
  ...
  // },
  {
    ...
    dropdown: [
      {
        label: "Admissions Overview", // 🔁 You can change this label from the combos below
        href: "/admission",
      },
      {
        label: "Apply Now",
  ...
  },
  {
    ...
    links: [
      {
        label: "Overview of Life at CSEI", // 🔁 You can change this label below
        href: "/life-with-csei",
      },
      {
        title: "Campus Life",
  ...
  },
  {
    ...
    links: [
      {
        label: "Placement Overview", // 🔁 You can change this label below
        href: "/placements",
      },
      {
        title: "Objective",
