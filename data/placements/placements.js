// src/data/placements/placement-cards.js
export const placementCards = [
  {
    ...
    image: {
      ...
      alt: "Industry experts providing career guidance to CSEI students",
    },
    keywords: ["career strategy", "placement objectives", "employment success"],
    stats: [
  ...
  },
  {
    ...
    image: {
      ...
      alt: "CSEI recruitment day with companies conducting interviews",
    },
    keywords: ["recruitment process", "placement program", "campus hiring"],
    stats: [
      "300+ corporate partners",
      "85% internship conversion",
  ...
  },
  {
    ...
    image: {
      ...
      alt: "Graduate signing employment contract with company executive",
    },
    keywords: [
      "hire graduates",
      "employer benefits",
  ...
  {
    id: "highlights",
    title: "CSEI Placement Highlights | Record Employment Statistics",
    description:
      "Explore our exceptional placement track record with 95% placement rate, highest salary packages, and top recruiting companies across industries worldwide.",
    link: "/placements/highlights",
    image: {
      url: "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=800&q=80",
      alt: "Placement statistics dashboard showing employment rates",
    },
    keywords: [
    ...
    stats: [
      ...
      "3.5 month average placement",
    ],
  },
  {
    id: "partners",
    title: "CSEI Industry Partners | Top Recruiting Companies",
    description:
      "Discover our network of 300+ premier corporate partners including Fortune 500 companies that regularly recruit CSEI graduates across all disciplines.",
    link: "/placements/partners",
    image: {
  ...
  {
    id: "book",
    title: "Partner With CSEI | Campus Recruitment Booking",
    description:
      "Join our elite network of recruiting partners. Book campus drives, schedule interviews, or request graduate profiles through our streamlined partnership portal.",
    link: "/placements/book",
    image: {
      url: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80",
      alt: "Executive signing partnership agreement with CSEI",
    },
    keywords: ["campus recruitment", "hire graduates", "partnership portal"],
    stats: [
