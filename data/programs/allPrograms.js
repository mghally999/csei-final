const allPrograms = [
  ...
  },
  {
    ...
    courseObjectives: [
      "Understand the fundamentals of HRM in hospitality and tourism settings.",
      "Develop recruitment and staffing strategies tailored to service-based organizations.",
      "Design training programs and enhance employee development.",
      "Apply motivational techniques and manage performance in dynamic environments.",
      "Understand and navigate legal and compliance responsibilities in HRM.",
      "Promote positive employee relations and build strong organizational culture.",
    ],
    assessmentVerification: [
  ...
  },
  {
    ...
    courseObjectives: [
      ...
      "Apply food safety and sanitation procedures in practical food service settings.",
      "Safely handle, store, and prepare food to regulatory standards.",
      "Identify hazards and control points in food preparation and service.",
      "Comply with food safety codes and inspection regulations.",
      "Promote clean and safe environments across hospitality operations.",
    ],
    assessmentVerification: [
  ...
  },
  {
    ...
    courseObjectives: [
      "Understand the principles and etiquette of food and beverage service.",
      "Use correct terminology and interpret menu items accurately.",
      "Deliver various service styles (e.g., à la carte, buffet, banquets) effectively.",
      "Interact professionally with guests and manage service scenarios.",
      "Handle wine, beverages, and food safely and hygienically.",
      "Apply operations knowledge to manage service flow and inventory.",
    ],
    assessmentVerification: [
